...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    assert_equal 9, result #0+1+2+3+4

    result2 = [2, 3, 4].inject(1) { |product, item| product * item }
    assert_equal 24, result2 #1*2*3*4

    # Extra Credit:
    # Describe in your own words what inject does.
    # This link describes inject() so well: https://stackoverflow.com/questions/710501/need-a-simple-explanation-of-the-inject-method
  end
